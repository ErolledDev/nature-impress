...
export default function SocialShareModal({ isOpen, onClose, postUrl, postTitle }) {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                <div className="flex items-center justify-between mb-6">
                  <Dialog.Title
                    ...
                    <ShareIcon className="w-5 h-5 text-brand-primary dark:text-brand-accent" />
                    Share this story
                  </Dialog.Title>
                  <button
                    type="button"
                    className="rounded-md p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                    onClick={onClose}>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {shareOptions.map((option) => (
                    <button
                      ...
                      className={`flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-600 transition-all duration-200 ${option.color} dark:text-gray-300`}>
                      {option.icon}
                ...
                <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
                  <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 bg-brand-primary hover:bg-brand-secondary text-white text-sm font-medium rounded-md transition-colors duration-200">
                      {copied ? (
                        <>
