...
export default function Footer(props) {
  return (
    <Container className="mt-16 sm:mt-20 border-t border-gray-100 dark:border-gray-800">
      {/* Social Media Links */}
      <div className="flex justify-center space-x-4 sm:space-x-6 py-6 sm:py-8">
        <a
          href="#"
      ...
      <div className="text-center text-sm sm:text-base py-6 sm:py-8">
        Copyright © {new Date().getFullYear()} {props?.copyright}. All
        rights reserved.
      </div>
      
      {/* Legal Links */}
      <div className="flex flex-wrap justify-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500 dark:text-gray-400 pb-4 px-4">
      ...
      <div className="flex flex-wrap justify-center gap-1 sm:gap-2 text-center text-xs sm:text-sm text-gray-500 dark:text-gray-600 mb-4 px-4">
