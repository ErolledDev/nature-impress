  ...
  return (
    <Container className="mt-16 sm:mt-20 border-t border-gray-100 dark:border-gray-800">
      ...
      <div className="flex justify-center space-x-3 sm:space-x-4 lg:space-x-6 py-4 sm:py-6 lg:py-8">
        <a
          href="#"
          className="text-gray-400 hover:text-brand-primary dark:hover:text-brand-accent transition-colors duration-200 p-1.5 sm:p-2 min-h-[44px] min-w-[44px] flex items-center justify-center"
          aria-label="Follow us on Facebook">
          <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      {/* Legal Links */}
      <nav className="flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4 text-xs sm:text-sm text-gray-500 dark:text-gray-400 pb-3 sm:pb-4 px-4" aria-label="Legal links">
        <a 
          href="/privacy-policy" 
          className="hover:text-brand-primary dark:hover:text-brand-accent transition-colors duration-200 min-h-[44px] flex items-center"
