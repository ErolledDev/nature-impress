...
async function fetchData() {
  ...
  if (!apiUrl) {
    console.warn('NEXT_PUBLIC_API_URL not configured, using fallback data');
  ...
  try {
    ...
    console.warn('Error fetching data from external API, using fallback data:', error.message);
    cachedData = fallbackData;
    return cachedData;
  }
}
